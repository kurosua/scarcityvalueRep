...
### Replicator's Note - Graphs from here on out are newly added by us.  We feel that visualizing this data helps understand that the effects for the following experiments are not large, and differences between groups are very small at times.  These figures are in color to better differentiate them from the figures in the paper (which were in black and white and were replicated in black and white).
-----
