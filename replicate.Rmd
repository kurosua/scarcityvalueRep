...
###### detect the user's directory:
directory  <- "C:/Users/Nick/Documents/Github/scarcityvalueRep/framing"
if (Sys.getenv('USER')=="air"){
  directory <- "~/Dropbox/SOC504/replicate/framing"
}
setwd(directory)
...
**^ Failed to replicate**
*didn't attempt wald because I don't know which model to use*
...
# Multinomal regression : using package : nnet : doesn't replicate
