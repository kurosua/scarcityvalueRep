...
summary(aov(judge ~ inc2*cond, df3_1))
temp_eta2 <- etaSquared(aov(judge ~ inc2*cond, df3_1)) %>%
  .[3,2] %>%
  round(digit=2)
print(c("ηp2:", temp_eta2), quote=F)
...
**^ replication is close, but off; not different enough to effect significance**
